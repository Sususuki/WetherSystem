...
function typeFun(b,c){
	...
	if(b=="晴"){
		...
		c.src="./img/xiaoyu.png"
	}
	else if(b=="中雨"){
		c.src="./img/zhongyu.png"
	}
	else if(b=="大雨"){
		c.src="./img/dayu.png"
	}
		...
		c.src="./img/zhenyu.png"
	}
	
	else if(b=="雷雨" || b=="雷阵雨"){
		c.src="./img/leizhenyu.png"
	}
	else if(b=="雨夹雪"){
		c.src="./img/yujiaxue.png"
	} 
	else if(b=="中雪"){
		c.src="./img/zhongdaxue.png"
	} 
	else if(b=="大雪"){
		c.src="./img/zhongdaxue.png"
	}
...
function typeMusic(b,c){
	if(b=="晴"){
		c.src="./img/qing.mp3";
	}
	else if(b=="晴转多云"||b=="阴"|| b=="多云"){
		c.src="./img/duoyun.mp3";
	}
	else if(b=="小雨"){
		c.src="./img/xiaoyu.mp3";
	}
	else if(b=="中雨"){
		c.src="./img/zhongyu.mp3";
	}
	else if(b=="大雨"){
		c.src="./img/dayu.mp3";
	}
		...
		c.src="./img/zhenyu.mp3";
	}
	
	else if(b=="雷雨" || b=="雷阵雨"){
		c.src="./img/leizhenyu.mp3";
	}
	else if(b=="雨夹雪"){
		c.src="./img/yujiaxue.mp3";
	} 
	else if(b=="中雪"){
		c.src="./img/zhongdaxue.mp3";
	} 
	else if(b=="大雪"){
		c.src="./img/daxue.mp3";
	}
